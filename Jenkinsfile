 ...
 stage('Install Dependencies') {
    ...
    stage('Docker Build and Push') {
      steps {
          ...
          sh 'docker build -t shiyi0618/my-app:${VERSION} .'
          sh 'docker push shiyi0618/my-app:${VERSION}'
      }
    }
     ...
     stage('Update Image Tag in GitOps') {
      steps {
       ...
       sh '''
          sed -i "s/image:.*/image: shiyi0618\\/my-app:${VERSION}/" aws/angular-manifest.yml
        '''
